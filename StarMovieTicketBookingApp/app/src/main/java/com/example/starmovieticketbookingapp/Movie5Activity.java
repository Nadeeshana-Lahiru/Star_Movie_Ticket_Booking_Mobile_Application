    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnNextMovie.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Movie5Activity.this, Movie1Activity.class);
        ...
        btnBuyTicket.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Movie5Activity.this, DateTimeActivity.class);
        ...
        btnComingSoon.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Movie5Activity.this, ComingSoonActivity.class);
