    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnNextMovie.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Movie3Activity.this, Movie4Activity.class);
        ...
        btnBuyTicket.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Movie3Activity.this, DateTimeActivity.class);
        ...
        btnComingSoon.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Movie3Activity.this, ComingSoonActivity.class);
