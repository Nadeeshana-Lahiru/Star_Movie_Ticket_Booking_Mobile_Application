    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnNextMovie.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Movie2Activity.this, Movie3Activity.class);
        ...
        btnBuyTicket.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Movie2Activity.this, DateTimeActivity.class);
        ...
        btnComingSoon.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Movie2Activity.this, ComingSoonActivity.class);
