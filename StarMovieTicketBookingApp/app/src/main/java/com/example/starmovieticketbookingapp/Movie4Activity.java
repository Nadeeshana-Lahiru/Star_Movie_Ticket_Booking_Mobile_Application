    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnNextMovie.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Movie4Activity.this, Movie5Activity.class);
        ...
        btnBuyTicket.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Movie4Activity.this, DateTimeActivity.class);
        ...
        btnComingSoon.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Movie4Activity.this, ComingSoonActivity.class);
